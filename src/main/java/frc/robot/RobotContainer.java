...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
            ...
            m_driverController2.rightTrigger().onTrue(new StartShooter(shooter));
            m_driverController2.rightBumper().onTrue(new StopShooter(shooter));
            m_driverController2.leftTrigger().whileTrue(new PassNote(shooter));
            m_driverController2.leftBumper().whileTrue(new IntakeShooter(shooter));
